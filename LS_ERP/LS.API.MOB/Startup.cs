...
namespace LS.API.MOB
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<AppMobileSettingsJson>(Configuration.GetSection("AppSettings"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory logger)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                {
                    FileProvider = new PhysicalFileProvider(Path.Combine(Directory.GetCurrentDirectory(), @"AttendanceImages")),
                    RequestPath = new PathString("/AttendanceImages")
                });
            }
            app.UseSwagger(c =>
            {
