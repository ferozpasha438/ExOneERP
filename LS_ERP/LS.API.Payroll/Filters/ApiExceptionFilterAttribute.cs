using CIN.Application.Common.Exceptions;
...
namespace LS.API.Payroll.Filters
{
    ...
    public class RouteDataRequestProvider : RequestCultureProvider
    {
        ...
        public override Task<ProviderCultureResult> DetermineProviderCultureResult(Microsoft.AspNetCore.Http.HttpContext httpContext)
        {
            ...
            ////var twoLetterCultureName = httpContext.Request.Headers..Path.Value.Split('/')[IndexOfCulture]?.ToString();
            ...
            //culture = "en-US";
            //culture = "ar-SA";
            httpContext.Items["SelectedLng"] = culture;
