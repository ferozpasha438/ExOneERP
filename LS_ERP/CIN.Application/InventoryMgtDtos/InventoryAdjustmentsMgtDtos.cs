...
{
    [AutoMap(typeof(TblIMAdjustmentsTransactionHeader))]
    public class TblIMAdjustmentsTransactionHeaderDto : AutoActiveGenerateIdAuditableKey<int>
    {
        [StringLength(20)]
        [Key]
    ...
    public class AdjustmentProductUnitPriceDTO
    {
    ...
    public class TblAdjustmentsInventoryReturntDto : TblIMAdjustmentsTransactionHeaderDto
    {

        public List<TblIMAdjustmentsTransactionDetailsDto> itemList { get; set; }
    }
    [AutoMap(typeof(TblIMAdjustmentsTransactionDetails))]
    public class TblIMAdjustmentsTransactionDetailsDto : AutoActiveGenerateIdKeyDto<int>
    {
    ...
    public class AdjacementrPaginationDto : TblIMAdjustmentsTransactionHeaderDto
    {
