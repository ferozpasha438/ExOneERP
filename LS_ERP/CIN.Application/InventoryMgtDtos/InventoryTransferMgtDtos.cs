...
{
    [AutoMap(typeof(TblIMTransferTransactionHeader))]
    public class TblIMTransferTransactionHeaderDto : AutoActiveGenerateIdAuditableKey<int>
    {
        [StringLength(20)]
        [Key]
    ...
    public class TransferProductUnitPriceDTO
    {
    ...
    public class TblTransferInventoryReturntDto : TblIMTransferTransactionHeaderDto
    {

        public List<TblIMTransferTransactionDetailsDto> itemList { get; set; }
    }
    [AutoMap(typeof(TblIMTransferTransactionDetails))]
    public class TblIMTransferTransactionDetailsDto : AutoActiveGenerateIdKeyDto<int>
    {
    ...
    public class TransferPaginationDto : TblIMTransferTransactionHeaderDto
    {
