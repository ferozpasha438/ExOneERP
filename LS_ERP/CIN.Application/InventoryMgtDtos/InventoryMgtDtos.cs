...
{
    [AutoMap(typeof(TblIMTransactionHeader))]
    public class TblIMTransactionHeaderDto : AutoActiveGenerateIdAuditableKey<int>
    {
        [StringLength(20)]
        [Key]
    ...
    public class TblInventoryReturntDto : TblIMTransactionHeaderDto
    {

        public List<TblIMTransactionDetailsDto> itemList { get; set; }
    }
    [AutoMap(typeof(TblIMTransactionDetails))]
    public class TblIMTransactionDetailsDto : AutoActiveGenerateIdKeyDto<int>
    {
    ...
    public class InventoryIMPaginationDto : TblIMTransactionHeaderDto
    {
