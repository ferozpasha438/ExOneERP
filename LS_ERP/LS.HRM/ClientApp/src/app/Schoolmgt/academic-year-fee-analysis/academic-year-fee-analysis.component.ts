...
@Component({
  selector: 'app-academic-year-fee-analysis',
  templateUrl: './academic-year-fee-analysis.component.html',
  styleUrls: []
})
export class AcademicYearFeeAnalysisComponent extends ParentSchoolMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['stuAdmNum', 'stuName', 'gradeCode', 'gradeSectionCode', 'totalFee', 'tax','netFee', 'paid','balance'];
  //data: any[] = [];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('Reports/AcademicFeeTransactionReport', this.utilService.getQueryString(page, pageCount, query, orderBy, this.gradeCode, "", this.academicYear, this.branchCode)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  exportexcel(): void {
    ...
    XLSX.writeFile(wb, "Academic_Fee_Transaction_Report.xlsx");
  }
