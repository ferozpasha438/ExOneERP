...
export class LessonPlanComponent extends ParentSchoolMgtComponent implements OnInit{
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['lessonPlanCode', 'gradeCode', 'subCodes', 'estStartDate', 'estEndDate', 'Actions'];
  ...
  //get():Array<any>{
  //  return [
  //    {id:1,lessonPlanCode:'Eng002',grade:'A',Subject:'English',startDate:'20/5/2022',endDate:'20/5/2022'},     
  // ]
  // }
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('LessonPlan', this.utilService.getTeacherQueryString(this.teacherCode,page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(id: number = 0, dbops: DBOperation, modalTitle: string, modalBtnTitle: string) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateLessonPlanComponent );
