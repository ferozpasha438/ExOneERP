...
@Component({
  selector: 'app-school-religion',
  templateUrl: './school-religion.component.html',
  styleUrls: []
})
export class SchoolReligionComponent extends ParentSchoolMgtComponent implements OnInit{
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['religionCode', 'religionName', 'religionNameInArabic',  'Actions'];
  ...
  get():Array<any>{
    return [
      { id: 1, regCode: 'Religion -1', regName: 'Religion -1', regName2:'Religion -1'},
      { id: 1, regCode: 'Religion -1', regName: 'Religion -1', regName2:'Religion -1'},
      { id: 1, regCode: 'Religion -1', regName: 'Religion -1', regName2:'Religion -1'},
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    this.isLoading = true;
    this.apiService.getPagination('schoolReligion', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(id: number = 0, dbops: DBOperation, modalTitle: string, modalBtnTitle: string) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateSchoolReligionComponent );
