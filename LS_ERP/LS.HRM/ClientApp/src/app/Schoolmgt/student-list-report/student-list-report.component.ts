...
export class StudentListReportComponent extends ParentSchoolMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['stuAdmNum', 'stuName', 'gradeCode', 'gradeSectionCode', 'nationality', 'parentContact', 'feeStuctureCode', 'feeAmount', 'due'];
  //data: any[] = [];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('Reports/StudentFeeListReport', this.utilService.getQueryString(page, pageCount, query, orderBy, this.gradeCode, "", this.academicYear, this.branchCode)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  exportexcel(): void {
    ...
    XLSX.writeFile(wb, "Student_Fee_List_Report.xlsx");
  }
