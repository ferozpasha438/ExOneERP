...
import { AddupdateaddresstypesComponent } from '../addupdateaddresstypes/addupdateaddresstypes.component';

@Component({
  selector: 'app-getaddresstypes',
  templateUrl: './getaddresstypes.component.html',
  styles: [],
})
export class GetaddresstypesComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddAddressType'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateAddressType'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('AddressType', id).subscribe((res) => {
            this.refresh();
