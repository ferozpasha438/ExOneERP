...
import { AddupdatereligionsComponent } from '../addupdatereligions/addupdatereligions.component';

@Component({
  selector: 'app-getreligions',
  templateUrl: './getreligions.component.html',
  styles: [],
})
export class GetreligionsComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddReligion'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateReligion'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('Religion', id).subscribe((res) => {
            this.refresh();
