...
import { AddupdatedegreetypesComponent } from '../addupdatedegreetypes/addupdatedegreetypes.component';

@Component({
  selector: 'app-getdegreetypes',
  templateUrl: './getdegreetypes.component.html',
  styles: [],
})
export class GetdegreetypesComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddDegreeType'),
      'Add'
    );
  }
  ...
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateDegreeType'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('DegreeType', id).subscribe((res) => {
            this.refresh();
