...
import { AddupdatelanguagesComponent } from '../addupdatelanguages/addupdatelanguages.component';

@Component({
  selector: 'app-getlanguages',
  templateUrl: './getlanguages.component.html',
  styles: [],
})
export class GetlanguagesComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddLanguage'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateLanguage'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('Language', id).subscribe((res) => {
            this.refresh();
