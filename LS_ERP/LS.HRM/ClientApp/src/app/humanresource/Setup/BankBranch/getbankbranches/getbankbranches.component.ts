...
import { AddupdatebankbranchesComponent } from '../addupdatebankbranches/addupdatebankbranches.component';

@Component({
  selector: 'app-getbankbranches',
  templateUrl: './getbankbranches.component.html',
  styles: [],
})
export class GetbankbranchesComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddBankBranch'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateBankBranch'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('BankBranch', id).subscribe((res) => {
            this.refresh();
