...
import { AddupdatevacationpolicyComponent } from '../addupdatevacationpolicy/addupdatevacationpolicy.component';

@Component({
  selector: 'app-getvacationpolicy',
  templateUrl: './getvacationpolicy.component.html',
  styles: [],
})
export class GetvacationpolicyComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddVacationPolicy'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateVacationPolicy'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('VacationPolicy', id).subscribe((res) => {
            this.refresh();
