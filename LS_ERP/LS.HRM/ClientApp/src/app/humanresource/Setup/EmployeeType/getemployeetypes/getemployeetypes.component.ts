...
import { AddupdateemployeetypesComponent } from '../addupdateemployeetypes/addupdateemployeetypes.component';

@Component({
  selector: 'app-getemployeetypes',
  templateUrl: './getemployeetypes.component.html',
  styles: [],
})
export class GetEmployeeTypesComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddEmployeeType'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdateEmployeeType'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('EmployeeType', id).subscribe((res) => {
            this.refresh();
