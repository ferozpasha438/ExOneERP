...
import { AddupdatepositionsComponent } from '../addupdatepositions/addupdatepositions.component';

@Component({
  selector: 'app-getpositions',
  templateUrl: './getpositions.component.html',
  styles: [],
})
export class GetpositionsComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddPosition'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdatePosition'),
      'Update'
    );
  }
