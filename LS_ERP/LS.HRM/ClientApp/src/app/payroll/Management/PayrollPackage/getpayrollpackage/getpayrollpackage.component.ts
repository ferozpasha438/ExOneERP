...
import { AddupdatepayrollpackageComponent } from '../addupdatepayrollpackage/addupdatepayrollpackage.component';
...
@Component({
  selector: 'app-getpayrollpackage',
  templateUrl: './getpayrollpackage.component.html',
  styles: [],
})
export class GetpayrollpackageComponent
  ...
  implements OnInit
{
  ...
  public create() {
    this.openDialogManage(
      0,
      DBOperation.create,
      this.translate.instant('AddPayrollPackage'),
      'Add'
    );
  }
  public edit(id: number) {
    this.openDialogManage(
      id,
      DBOperation.update,
      this.translate.instant('UpdatePayrollPackage'),
      'Update'
    );
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(
      (canDelete) => {
        if (canDelete && id > 0) {
          this.apiService.delete('PayrollPackage', id).subscribe((res) => {
            this.refresh();
