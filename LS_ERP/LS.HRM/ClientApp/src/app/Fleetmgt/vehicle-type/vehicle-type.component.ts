...
export class VehicleTypeComponent extends ParentFleetMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['vehicleType','vehicleTypeInArabic','Actions'];
  ...
  get(): Array<any> {
    return [
      { id: 1, vehicleType: 'Type-1', vehicleTypeInArabic: 'Type-3' },
      { id: 1, vehicleType: 'Type-2', vehicleTypeInArabic: 'Type-3' },
      { id: 1, vehicleType: 'Type-3', vehicleTypeInArabic: 'Type-3' },
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    this.isLoading = true;
    this.apiService.getPagination('vehicleType', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(row: any) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateVehicleTypeComponent);
