...
export class VehicleCompanyComponent extends ParentFleetMgtComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator!: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort!: MatSort;
  displayedColumns: string[] = ['vehicleCompany','vehicleCompanyInArabic','Actions'];
  ...
  get(): Array<any> {
    return [
      { id: 1, vehicleCompany: 'Company-1', vehicleCompanyInArabic: 'Company-3' },
      { id: 1, vehicleCompany: 'Company-2', vehicleCompanyInArabic: 'Company-3' },
      { id: 1, vehicleCompany: 'Company-3', vehicleCompanyInArabic: 'Company-3' },
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    this.isLoading = true;
    this.apiService.getPagination('vehicleCompany', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(row: any) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateVehicleCompanyComponent);
