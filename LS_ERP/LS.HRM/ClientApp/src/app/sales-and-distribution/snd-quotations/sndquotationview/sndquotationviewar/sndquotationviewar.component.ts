...
@Component({
  selector: 'app-sndquotationviewar',
  templateUrl: './sndquotationviewar.component.html'
})
export class SndquotationviewarComponent implements OnChanges {
  bank: any;
  customer: any;
  company: any;
  quotation: any;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (this.res) {
      ...
      this.quotation = this.res['quotation'];
      this.items = this.res['quotationItems'] as Array<any>;
      this.footerDiscount = this.quotation['footerDiscount'];
