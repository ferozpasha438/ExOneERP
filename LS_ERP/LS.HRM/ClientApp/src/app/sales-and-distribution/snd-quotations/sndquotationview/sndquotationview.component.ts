...
@Component({
  selector: 'app-sndquotationview',
  templateUrl: './sndquotationview.component.html'
})
export class SndquotationviewComponent extends ParentSalesMgtComponent implements OnInit {
  ...
  constructor(private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<SndquotationviewComponent>,
  ...
  loadSalesView() {
    this.isLoading = true;
    this.apiService.get("generateSndQuotation/generateSndQuotationReportById", this.id).subscribe(res => {
