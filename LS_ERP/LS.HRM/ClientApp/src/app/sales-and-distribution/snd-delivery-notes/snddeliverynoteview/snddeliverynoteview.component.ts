...
@Component({
  selector: 'app-snddeliverynoteview',
  templateUrl: './snddeliverynoteview.component.html'
})
export class SnddeliverynoteviewComponent extends ParentSalesMgtComponent implements OnInit {
  ...
  constructor(private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<SnddeliverynoteviewComponent>,
  ...
  loadSalesView() {
    this.isLoading = true;
    this.apiService.get("SndDeliveryNote/getSndDeliveryNoteReportById", this.id).subscribe(res => {
