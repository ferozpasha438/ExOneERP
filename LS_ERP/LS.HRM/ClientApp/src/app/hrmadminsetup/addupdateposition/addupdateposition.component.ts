...
@Component({
  selector: 'app-addupdateposition',
  templateUrl: './addupdateposition.component.html'
})
export class AddupdatepositionComponent extends ParentHrmAdminComponent implements OnInit {
  modalTitle: string;
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<AddupdatepositionComponent>,
