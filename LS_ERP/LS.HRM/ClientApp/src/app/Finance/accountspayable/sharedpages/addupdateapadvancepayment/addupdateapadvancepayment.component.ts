...
@Component({
  selector: 'app-addupdateapadvancepayment',
  templateUrl: './addupdateapadvancepayment.component.html',
  styles: [
  ]
})
export class AddupdateapadvancepaymentComponent implements OnInit {
  form!: FormGroup;
  id: number = 0;
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService,
    ...
    public dialogRef: MatDialogRef<AddupdateapadvancepaymentComponent>, public dialog: MatDialog,
