...
export class PostingComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<PostingComponent>,
  ...
  submit() {
    if (this.form.valid) {
      if (this.id > 0) {
        ...
        this.apiService.post('journalVoucher/createJournalVoucherPosting', this.form.value)
          .subscribe(res => {
