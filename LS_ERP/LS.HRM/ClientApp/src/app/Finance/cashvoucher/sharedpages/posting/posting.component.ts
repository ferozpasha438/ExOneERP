...
@Component({
  selector: 'app-chposting',
  templateUrl: './posting.component.html',
  styles: [
  ]
})
export class ChPostingComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService,
    private authService: AuthorizeService, private utilService: UtilityService, public dialogRef: MatDialogRef<ChPostingComponent>,
  ...
  submit() {
    if (this.form.valid) {
      if (this.id > 0) {
        ...
        this.apiService.post('cashVoucher/createcashVoucherPosting', this.form.value)
          .subscribe(res => {
