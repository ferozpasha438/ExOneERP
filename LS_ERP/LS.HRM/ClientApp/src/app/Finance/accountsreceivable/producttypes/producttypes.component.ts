...
import { AddupdateproducttypeComponent } from '../sharedpages/addupdateproducttype/addupdateproducttype.component';
import { AddupdateunittypeComponent } from '../sharedpages/addupdateunittype/addupdateunittype.component';
...
export class ProducttypesComponent extends ParentFinMgtComponent implements OnInit {
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('productType', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(row: any) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdateproducttypeComponent);
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(canDelete => {
      if (canDelete && id > 0) {
        this.apiService.delete('productType', id).subscribe(res => {
          this.refresh();
