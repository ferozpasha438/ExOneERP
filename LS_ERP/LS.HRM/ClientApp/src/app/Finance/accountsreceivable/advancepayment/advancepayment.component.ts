...
import { AddupdateadvancepaymentComponent } from '../sharedpages/addupdateadvancepayment/addupdateadvancepayment.component';
...
export class AdvancepaymentComponent extends ParentFinMgtComponent implements OnInit {
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('opmArPayment/getCustomerAdvancePaymentPazedList', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  public addAdvance() {
    this.openDialogManage(0, DBOperation.update, this.translate.instant('Add_Advance_Payment'), '', AddupdateadvancepaymentComponent);
