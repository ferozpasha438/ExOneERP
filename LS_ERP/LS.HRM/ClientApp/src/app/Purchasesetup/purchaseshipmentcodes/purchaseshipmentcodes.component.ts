...
@Component({
  selector: 'app-purchaseshipmentcodes',
  templateUrl: './purchaseshipmentcodes.component.html',
  styleUrls: []
})
export class PurchaseshipmentcodesComponent extends ParentSystemSetupComponent implements OnInit {
  ...
  displayedColumns: string[] = ['shipmentCode', 'shipmentName', 'shipmentDesc', 'shipmentType','Actions'];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('purchaseshipmentcode', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(id: number = 0, dbops: DBOperation, modalTitle: string, modalBtnTitle: string) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdatepurchaceshipmentcodeComponent);
  ...
  public create() {
    this.openDialogManage(0, DBOperation.create, 'Adding New Purchaseshipment Code', 'Add');
  }

  public edit(id: number) {
    this.openDialogManage(id, DBOperation.update, 'Updating Purchaseshipment Code', 'Update');
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(canDelete => {
      if (canDelete && id > 0) {
        this.apiService.delete('purchaseshipmentcode', id).subscribe(res => {
          this.refresh();
