...
@Component({
  selector: 'app-purchasevendorcategory',
  templateUrl: './purchasevendorcategory.component.html',
  styleUrls: []
})
export class PurchasevendorcategoryComponent extends ParentSystemSetupComponent implements OnInit {
  @ViewChild(MatPaginator, { static: true }) paginator: MatPaginator;
  @ViewChild(MatSort, { static: true }) sort: MatSort;

  displayedColumns: string[] = ['VenCategoryCode', 'VenCategoryName', 'VenDescriptionName', 'Actions'];
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined) {
    ...
    this.apiService.getPagination('PurchaseVendorcategory', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
  ...
  private openDialogManage(id: number = 0, dbops: DBOperation, modalTitle: string, modalBtnTitle: string) {
    let dialogRef = this.utilService.openCrudDialog(this.dialog, AddupdatepurchasevendorcategoryComponent);
  ...
  public create() {
    this.openDialogManage(0, DBOperation.create, 'Adding New  Ven Category', 'Add');
  }

  public edit(id: number) {
    this.openDialogManage(id, DBOperation.update, 'Updating Ven Category', 'Update');
  }
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(canDelete => {
      if (canDelete && id > 0) {
        this.apiService.delete('PurchaseVendorcategory', id).subscribe(res => {
          this.refresh();
