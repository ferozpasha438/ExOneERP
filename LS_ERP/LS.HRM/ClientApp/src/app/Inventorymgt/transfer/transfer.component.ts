...
export class TransferComponent extends ParentInventoryMgtComponent implements OnInit {
  ...
  public edit(id: number) {
    this.openDialogManage(id, DBOperation.update, this.translate.instant('Create_New_Adjustments'), '', AddupdatetransferComponent);
  }
  ...
  //  this.apiService.post('InventoryAdjustments/CreateIssuesRequest', this.form.value)
  //    .subscribe(res => {
  //      debugger;
  //      this.reset();
  ...
  approvePurchaseOrder(project: any) {
    ...
    this.openApprovalDialog(branchCode, serviceCode, DBOperation.create, 'Transfer', 'Save', serviceType, ApprovaldialogwindowsComponent);
