...
@Component({
  selector: 'app-addupdatereceipts',
  templateUrl: './addupdatereceipts.component.html',
  styleUrls: []
})
export class AddupdatereceiptsComponent implements OnInit {
...
/*  itemTaxPer: string = '';*/
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private router: Router, private apiService: ApiService,
    ...
    private notifyService: NotificationService, private validationService: ValidationService, public pageService: PaginationService, public dialog: MatDialog, public dialogRef: MatDialogRef<AddupdatereceiptsComponent>) {
  ...
  public edit() {
    ...
    this.apiService.get('InventoryReceipts', this.id).subscribe(res => {
      if (res) {
