...
@Component({
  selector: 'app-addupdatetransfer',
  templateUrl: './addupdatetransfer.component.html',
  styleUrls: []
})
export class AddupdatetransferComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private router: Router, private apiService: ApiService,
    ...
    private notifyService: NotificationService, private validationService: ValidationService, public pageService: PaginationService, public dialog: MatDialog, public dialogRef: MatDialogRef<AddupdatetransferComponent>) {
  ...
  Users() {
    this.apiService.getall('InventoryTransfer/GetTransferUserSelectList').subscribe(res => {
      if (res) {
  ...
  FromLocation() {
    this.apiService.getall('InventoryTransfer/GetTransferToLocationList').subscribe(res => {
      if (res) {
  ...
  Accounts() {
    this.apiService.getall('InventoryTransfer/GetTransferAccountSelectList').subscribe(res => {
      if (res) {
  ...
  AdjAccounts() {
    this.apiService.getall('InventoryTransfer/GetAdjustmentAccountSelectList').subscribe(res => {
      if (res) {
  ...
  JVNumber() {
    this.apiService.getall('InventoryTransfer/GetAdjustmentJVNumberSelectList').subscribe(res => {
      if (res) {
        this.jVNumList = res;
      }
    })
  ...
  loadItemCode() {
    this.apiService.getall('InventoryTransfer/GetTransferItemCodeList').subscribe(res => {
      if (res) {
  ...
  loadbarCode() {
    this.apiService.getall('InventoryTransfer/GetTransferBarCodeSelectList').subscribe(res => {
      if (res) {
  ...
  loadUnitCode() {
    this.apiService.getall('InventoryTransfer/GetTransferUOMSelectList').subscribe(res => {
      if (res) {
        this.UOMList = res;
      }
    })
  ...
  loadUomdata(event: any) {
    ...
    if (ItemList) {
      ...
      this.apiService.getall(`InventoryTransfer/TransferProductUomtPriceItem/${ItemList}`).subscribe(res => {
  ...
  private loadList(page: number | undefined, pageCount: number | undefined, query: string | null | undefined, orderBy: string | null | undefined, approval: string = "") {
    ...
    this.apiService.getPagination('InventoryTransfer', this.utilService.getQueryString(page, pageCount, query, orderBy)).subscribe(result => {
      this.totalItemsCount = 0;
      this.data = new MatTableDataSource(result.items);
  ...
  purchaseOrdersubmit() {
    ...
    this.apiService.post('InventoryTransfer', this.form.value)
      .subscribe(res => {
        debugger;
  ...
  public delete(id: number) {
    ...
    dialogRef.afterClosed().subscribe(canDelete => {
      if (canDelete && id > 0) {
        this.apiService.delete('InventoryTransfer', id).subscribe(res => {
          this.refresh();
          this.utilService.OkMessage();
        },
        );
  ...
  submit() {
    ...
    if (this.listOfInvoices.length > 0) {
      ...
      this.apiService.post('InventoryTransfer/TransferCreateIssuesRequest', this.form.value)
        .subscribe(res => {
          debugger;
          this.reset();
  ...
  public edit() {
    ...
    this.apiService.get('InventoryTransfer', this.id).subscribe(res => {
      if (res) {
  ...
  public view(id: number) {
    this.openDialogManage(id, DBOperation.create, '', '', AdjustmentsComponent, { action: '', module: '' }, 100);
  }
