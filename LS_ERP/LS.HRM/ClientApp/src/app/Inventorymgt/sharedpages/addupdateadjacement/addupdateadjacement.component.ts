...
@Component({
  selector: 'app-addupdateadjacement',
  templateUrl: './addupdateadjacement.component.html',
  styleUrls: []
})
export class AddupdateadjacementComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private router: Router, private apiService: ApiService,
    ...
    private notifyService: NotificationService, private validationService: ValidationService, public pageService: PaginationService, public dialog: MatDialog, public dialogRef: MatDialogRef<AddupdateadjacementComponent>) {
  ...
  submit() {
    ...
    this.apiService.post('InventoryAdjustments/AdjustmentCreateIssuesRequest', this.form.value)
      .subscribe(res => {
        debugger;
        this.reset();
