...
export class IssuesComponent extends ParentInventoryMgtComponent implements OnInit {
  ...
  //  this.apiService.get('InventoryTransaction', id).subscribe(res => {
  //    if (res) {
  ...
  //}
  public create() {
    this.openDialogManage(0, DBOperation.create, this.translate.instant('Create_New_Issues'), '', AddupdateissuesComponent);
  }
