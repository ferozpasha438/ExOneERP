...
export declare class TreeviewComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TreeviewComponent, "ngx-treeview", never, { "config": "config"; "headerTemplate": "headerTemplate"; "itemTemplate": "itemTemplate"; "items": "items"; }, { "selectedChange": "selectedChange"; "filterChange": "filterChange"; }, never, never>;
}
