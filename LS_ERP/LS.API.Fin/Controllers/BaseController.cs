...
namespace LS.API.Fin.Controllers
{
    ...
    public class FileBaseController : BaseController
    {
        ...
        protected static char ConvertUnicodeStringToAscii(int value) => Microsoft.VisualBasic.Strings.Chr(value);
        ...
        protected string GenerateQRCode(string sellerName, string vatNumber, string taxAmount, string totalInclAmount, string CreatedOn)
        {
            ...
            using (MemoryStream memory = new MemoryStream())
            {
                ...
                return $"data:image/jpg;base64,{Convert.ToBase64String(memory.ToArray())}"; ;
            }
